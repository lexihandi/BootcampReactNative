...
const styles = StyleSheet.create({
  ...
  descContainer: {flexDirection: 'row', paddingTop: 15},
  videoTitle: {fontSize: 15, color: '#3c3c3c'},
  videoDetails: {paddingHorizontal: 15, flex: 1},
  videoStats: {fontSize: 14, paddingTop: 3, color: '#3c3c3c'},
});
